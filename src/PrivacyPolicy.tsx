...
export default function PrivacyPolicy() {
  return (
    <section className="relative font-poppins bg-[#001524]  text-white py-8 px-4 overflow-hidden">
      ...
      >
        <div className="space-y-2 rounded-2xl bg-white/5  shadow-lg backdrop-blur-sm border border-[#FF6B2C]/30">
          ...
          <footer className="border-t border-[#FF6B2C]/30 pt-6 text-center text-sm text-gray-400">
            Astrowallas © 2025 | All Rights Reserved
          </footer>
        </div>
      </motion.div>
