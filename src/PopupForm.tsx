...
//       try {
//         await fetch(
//           "https://script.google.com/macros/s/AKfycbyBEkqNDPZgrtA_hvLRUyjYhuLBLrZ9ysAn0llSFHreICtK817weRVyt-buL5JVeT0PEQ/exec",
//           {
//             method: "POST",
//             mode: "no-cors",
//             headers: {
...
// Define Facebook Pixel interface
...
const PopupForm: React.FC<PopupFormProps> = ({ isOpen, onClose }) => {
  ...
  const whatsappGroupLink = "https://chat.whatsapp.com/I0WAv3zyFnLEGxF2py0tix";
  ...
  // Function to track Facebook lead with proper typing
  const trackFacebookLead = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (Object.keys(newErrors).length === 0) {
      ...
      try {
        ...
        // Track the lead after successful form submission
        trackFacebookLead();
